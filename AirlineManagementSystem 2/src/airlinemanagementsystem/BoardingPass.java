...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        fetchButton.setFont(new Font("Tahoma", Font.BOLD, 18));
        ...
        lblnationality.setFont(new Font("Tahoma", Font.BOLD, 17));
        add(lblnationality);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/pn.jpg"));
