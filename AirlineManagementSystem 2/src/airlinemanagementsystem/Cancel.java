...
public class Cancel extends JFrame implements ActionListener{
    ...
    public Cancel() {
        ...
        heading.setBounds(230, 20, 250, 35);
        heading.setFont(new Font("Tahoma", Font.BOLD, 30));
        heading.setForeground(Color.BLACK);
        add(heading);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/ticketcencle.png"));
        ...
        fetchButton.setFont(new Font("Tahoma", Font.BOLD, 13));
        ...
        flight.setFont(new Font("Tahoma", Font.BOLD, 17));
