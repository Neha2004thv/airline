...
public class BookFlight extends JFrame implements ActionListener{
    ...
    public BookFlight() {
        ...
        heading.setBounds(420, 20, 600, 35);
        ...
        lbldest.setFont(new Font("Tahoma", Font.BOLD, 18));
        add(lbldest);
        ...
        flight.setFont(new Font("Tahoma", Font.BOLD, 16));
        ...
        lblfcode.setFont(new Font("Tahoma", Font.BOLD, 18));
        add(lblfcode);
        ...
        ImageIcon image = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/login.png"));
        JLabel lblimage = new JLabel(image);
        lblimage.setBounds(480, 80, 410, 400);
        add(lblimage);
